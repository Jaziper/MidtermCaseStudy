...
if ($stmt) {
    // Get user ID using username from the session
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($update_stmt) {
        ...
        if ($update_stmt->execute()) {
            ...
            $_SESSION["profile_update_success"] = "Profile information successfully updated!";
        } else {
...
<div class="container mt-5">
    ...
    if (isset($_SESSION["profile_update_success"])) {
        echo "<div class='alert alert-success'>" . $_SESSION["profile_update_success"] . "</div>";
        unset($_SESSION["profile_update_success"]); // Remove the message from the session
    }
    ?>
    <ul class="list-group">
